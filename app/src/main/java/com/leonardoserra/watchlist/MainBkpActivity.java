...
public class MainBkpActivity extends AppCompatActivity {
    ...
    protected void handleMenuSearch(){
        ...
        if (isSearchOpened){ //test if the search is open
            ...
            Singleton.getInstance().trocaFragEInsereNoHistorico(Singleton.getInstance().getFragmentAtual());
    ...
    public void onBackPressed() {
        ...
        if(isSearchOpened) {
            ...
            if (qtd == 1){
                ...
                Singleton.getInstance().removeUltimoFragmentDoHistorico();
                    ...
                    case "FragmentSearchResult":
                        switch (fragmentAnterior) {
                            ...
                            case "FragmentMyListt":
                                ...
                                break;
                            case "FragmentSearchResult":
                                Singleton.getInstance().mostraPenultimoResultadoBusca();
                                break;
                        }
                        break;
                }
